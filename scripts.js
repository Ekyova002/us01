setTimeout(function () {
  ...
  function startScan() {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
          document.getElementById("info").innerHTML = "Threat detected. <br> Last scan: " + date_time + "<br> 11 threats found. <br> Scan lasted 0 minutes, 6 seconds. <br> 3821 scanned file. "
      }, 800);
      setTimeout(function () {
      ...
      $(".alert_popup").delay(400).fadeIn(200);
      $(".websa").delay(500).fadeIn(200);
